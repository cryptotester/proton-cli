...
var argv = require('yargs/yargs')(process.argv)
    ...
    .example('$0 -c flytothemoon --template_id 21 --from 4398046516712 --to 4398046516714 -p 5')
    .example('$0 --from 1001000 --to 1002000 -p 5 -b --bs 10 --bt 5', 'Sell range of asset_ids in batch mode for 5 XUSDC, 20 NFTs per batch, every 5 seconds')
    .example('$0 --from 1001000 --to 1002000 -p 5 -b', 'Sell range of asset_ids in batch mode for 5 XUSDC, 15 (default is 15) NFTs per batch, every 6 (default is 6) seconds')
    ...
    .describe('yes', 'Answer YES: skipping the prompt to press a key to continue')
    .boolean(['yes'])
    .alias('y', 'yes')
    .describe('batch', 'Batch mode')
    .boolean(['batch'])
    .alias('b', 'batch')
